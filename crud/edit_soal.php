...
<body>
    ...
    <form action="proses_edit.php" method="POST">
        ...
        <textarea name="pertanyaan" id="pertanyaan" rows="4" required><?= $soal['pertanyaan'] ?></textarea><br><br>

        <label for="opsi_a">Opsi A:</label>
        <input type="text" name="opsi_a" id="opsi_a" value="<?= $soal['opsi_a'] ?>" required><br>

        <label for="opsi_b">Opsi B:</label>
        <input type="text" name="opsi_b" id="opsi_b" value="<?= $soal['opsi_b'] ?>" required><br>

        <label for="opsi_c">Opsi C:</label>
        <input type="text" name="opsi_c" id="opsi_c" value="<?= $soal['opsi_c'] ?>" required><br>

        <label for="opsi_d">Opsi D:</label>
        <input type="text" name="opsi_d" id="opsi_d" value="<?= $soal['opsi_d'] ?>" required><br>
